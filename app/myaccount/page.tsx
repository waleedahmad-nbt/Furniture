...
const MyAccount = () => {
  ...
  return (
    <div className="container">
      <h1 className="text-gray-900 font-medium text-[48px] text-center my-7">My Account</h1>
      <div className="bg-white px-10 py-10 rounded-sm flex flex-wrap mb-16">
        ...
        <div className="flex-[0_0_70%] pl-5">
          <form onSubmit={handleSubmit}>
            <h2 className="text-gray-900 font-medium text-[20px]">Account Details</h2>
            ...
            <div className="mt-5">
              ...
              <p className="text-gray-200 text-[12px] mt-2"><i>This will be how your name will be displayed in the account section and in reviews</i></p>
            </div>
            <div className="mt-5">
            ...
            <h2 className="text-gray-900 font-medium text-[20px] mt-10">Password</h2>
            <div className="mt-5">
            ...
            <button type="submit" className="bg-primary text-white font-medium px-8 py-3 mt-5">Save changes</button>
          </form>
        </div>
      </div>
    </div>
