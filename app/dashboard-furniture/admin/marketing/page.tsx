    ...
    <div className=" py-6 w-3/5 m-auto">
      <div className="Orderbar w-full flex justify-between items-center mb-7">
        <div className="relative">
          <h1 className="text-xl font-bold flex items-center">Marketing</h1>
        </div>

        <div className="space-x-3">
          <button className="p-1 bg-gray-900/80 hover:bg-gray-900/100 duration-100 text-white text-sm px-2 rounded-lg">
            Create campaign
          </button>
        </div>
      </div>
      ...
      <div className="w-full grid grid-cols-3 gap-4 mt-8">
        <div className="p-5 bg-white rounded-xl">
          ...
          <p className="text-2xl font-bold">
            309
            <span className="text-xs font-medium px-1 text-primary flex items-center">
              <FiArrowUpRight /> 55%{" "}
            </span>{" "}
          </p>
          <Marketgraph />
        ...
        <div className="p-5 bg-white rounded-xl">
          ...
          <p className="text-2xl flex font-bold">
            1.93%
            <span className="text-xs px-1 text-primary flex items-center font-medium">
              <FiArrowUpRight /> 55%{" "}
            </span>{" "}
          </p>
          <Marketgraph />
      ...
      <div className="py-4 font-bold space-y-3">
        ...
        <div className="space-x-4">
          <button className="rounded-lg py-1 text-sm opacity-70 hover:opacity-100">
      ...
      <div className="py-6 px-4 mb-4 bg-white w-full rounded-xl font-bold">
        <div className="flex justify-between ">
        ...
        <table className="min-w-full text-xs divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200 font-normal">
            {activities?.map(( product: any, i: any) => (
              <tr key={i} className="">
                <td className="pr-3 flex items-center py-3 whitespace-nowrap text-left w text-xs font-bold">
                  <Image className="w-[15px] mr-2" src={product.image} alt="" /> {product.channel}
                  <div>
                ...
                >
                  <Menu as="div" className="relative z-30 inline-block text-left">
                    <div>
                      <Menu.Button className="text-lg font-bold inline-flex w-full justify-center gap-x-1.5 rounded-md bg-transparent px-2 py-1 text-gray-900 hover:bg-[#E3E3E3]">
                        <BsThreeDots />
                      </Menu.Button>
                    </div>
      ...
      <div className="py-6 px-4 mb-4 bg-white w-full rounded-xl font-bold">
        ...
        <div className="my-3 grid gap-3 lg:grid-cols-3 md:grid-cols-2 grid-cols-1">
          <div className="flex gap-3">  
            ...
            <div>
              ...
              <p className="text-sm font-normal">Boost your brand presence and connect with customers on Shop</p>
              <span className="text-blue-600 text-xs underline cursor-pointer hover:text-blue-800">
              Set up app
              </span>
            </div>
          ...
          <div className="flex gap-3">  
            ...
            <div>
              <h1 className="text-blue-600 my-1 text-xs hover:underline cursor-pointer hover:text-blue-800">Shop</h1>
              <p className="text-sm font-normal">Grow your business with shoppable ads on Snapchat!</p>
              <span className="text-blue-600 text-xs underline cursor-pointer hover:text-blue-800">
              Set up app
              </span>
            </div>
          ...
          <div className="flex gap-3">  
            ...
            <div>
              <h1 className="text-blue-600 my-1 text-xs hover:underline cursor-pointer hover:text-blue-800">Shop</h1>
              <p className="text-sm font-normal">Email marketing newsletters, automations, templates & restock</p>
              <span className="text-blue-600 text-xs underline cursor-pointer hover:text-blue-800">
              Set up app
              </span>
            </div>
          ...
          <div className="flex gap-3">  
            ...
            <div>
              <h1 className="text-blue-600 my-1 text-xs hover:underline cursor-pointer hover:text-blue-800">Shop</h1>
              <p className="text-sm font-normal">Drive sales with email marketing, newsletters, SMS, and popups</p>
              <span className="text-blue-600 text-xs underline cursor-pointer hover:text-blue-800">
              Set up app
              </span>
            </div>
          ...
          <div className="flex gap-3">  
            ...
            <div>
              <h1 className="text-blue-600 my-1 text-xs hover:underline cursor-pointer hover:text-blue-800">Shop</h1>
              <p className="text-sm font-normal">Email & Text Marketing, SMS Automation and Abandoned Carts</p>
              <span className="text-blue-600 text-xs underline cursor-pointer hover:text-blue-800">
                Set up app
              </span>
            </div>
        ...
        <button className="rounded-lg text-sm p-1 px-2 mx-1 flex items-center shadow-sm border font-bold bg-white hover:shadow-none">
      ...
      <div className="py-6 px-4 mb-4 pb-10 bg-white w-full rounded-xl font-bold">
        <p className="text-sm pt-6">
        ...
        <Slider {...settings} className="font-normal">
          <div className="my-2">
            <div className="w-full border overflow-hidden rounded-lg flex">
              <Image className="w-[35%]" src={slider1} alt="" />
              <div className="w-[65%] p-5">
                <p className="font-bold my-2 text-sm">Introducing Shopify Email</p>
                <p className="my-2 text-sm">Learn how to connect with your customers using Shopify Email.</p>
                <button className="rounded-lg text-sm p-1 px-2 flex items-center shadow-sm border font-medium bg-white hover:shadow-none">
          ...
          <div className="my-2">
            <div className="w-full border overflow-hidden rounded-lg flex">
              ...
              <div className="w-[65%] p-5">
                <p className="font-bold my-2 text-sm">Introducing Shopify Email</p>
                <p className="my-2 text-sm font-normal">Learn how to connect with your customers using Shopify Email.</p>
                <button className="rounded-lg text-sm p-1 px-2 flex items-center shadow-sm border font-medium bg-white hover:shadow-none">
                  Explore Shopify Email
                </button>
              </div>
