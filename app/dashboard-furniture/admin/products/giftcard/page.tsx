  ...
  return (
    <div className="p-5">
      ...
      <div className="bg-white border rounded-lg p-5 py-10 flex flex-col justify-center items-center">
          ...
          <h1 className="text-sm font-bold">Start selling gift cards</h1>
          <p className="text-xs my-2">Add gift card products to sell or issue gift cards directly to your customers.</p>
