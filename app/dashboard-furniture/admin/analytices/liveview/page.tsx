      ...
      <div className="py-3 mb-2 flex justify-between items-center">
        <div>
          <div className="flex items-center gap-2">
            ...
            <p className="text-sm">Sep 5, 2023 at 11:50 AM GMT+5</p>
          </div>
          <div className="flex items-center gap-1 mt-3">
            ...
            <p className="text-sm mr-3">Orders</p>
            <Image src={visitorImage} alt="" />
            <p className="text-sm">Visitors right now</p>
          </div>
        </div>
        <div className="flex justify-center gap-2 items-center">
          <button className="rounded-lg text-lg p-1 px-2 mx-1 flex items-center shadow-sm border bg-white hover:shadow-none">
            <AiOutlineEye />
          </button>
          <button className="rounded-lg text-lg p-1 px-2 mx-1 flex items-center shadow-sm border bg-white hover:shadow-none">
            <AiOutlineBarChart />
        ...
        <div className="col-span-1 h-full p-5 overflow-auto">
          <div className="w-full mb-5 grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-4 mt-8">
            <div className="p-3 bg-white rounded-xl">
              <p className="w-max text-sm">Visitors right now</p>
              <hr className="h-[1px] border-dashed border-[1px]" />
              <p className="text-xl flex">4</p>
            </div>
            <div className="p-3 bg-white rounded-xl">
              <p className="w-max text-sm">Total sales</p>
              <hr className="h-[1px] border-dashed border-[1px]" />
              <p className="text-xl flex">Rs 234.00</p>
            </div>
            <div className="p-3 bg-white rounded-xl">
              <p className="w-max text-sm">Total sessions</p>
              <hr className="h-[1px] border-dashed border-[1px]" />
              <p className="text-xl flex">278</p>
            </div>
            <div className="p-3 bg-white rounded-xl">
              <p className="w-max text-sm">Total orders</p>
              <hr className="h-[1px] border-dashed border-[1px]" />
              <p className="text-xl flex">3</p>
            </div>
          </div>
          ...
          <div className="p-3 mb-4 bg-white rounded-xl">
            ...
            <div className="w-full rounded flex items-center h-2.5 mb-4">
              ...
              <span className="text-xs">30 sessions</span>
            </div>
            ...
            <div className="w-full rounded flex items-center h-2.5 mb-4">
              ...
              <span className="text-xs">24 sessions</span>
            </div>     
          </div>
          ...
          <div className="p-3 mb-4 bg-white rounded-xl">
            ...
            <div className="w-full rounded flex items-center h-2.5 mb-4">
              ...
              <span className="text-xs">3 customers</span>
            </div>
            <div className="mb-1 text-xs  dark:text-white">Returning</div>
            <div className="mb-1 text-xs">|  0 customers</div>
          </div>
          ...
          <div className="p-3 mb-4 bg-white rounded-xl">
            ...
            <div className="flex justify-between gap-2 items-center">
                ...
                <p className="text-xs">Rs 900.00</p>
            </div>
            ...
            <div className="bg-white rounded-lg">
              <div className="flex justify-between items-center p-2">
                <div className="flex justify-center items-center gap-2">
                  <button className={`rounded-lg text-sm p-1 px-2  hover:bg-[#f3f3f3]`}>
                    All
                  </button>
                  <button className={`rounded-lg text-sm p-1 px-2  hover:bg-[#f3f3f3]`}>
                    +
