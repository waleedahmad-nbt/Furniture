    ...
    <>
      ...
      :<>
          <div className="sm:px-10 px-3">
            <h1 className="text-2xl text-ubuntu-bold mb-5 text-HeadingColours">Returns</h1>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {data && data.map((product, i) => {
                  ...
                  <tr key={i}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-xs text-gray-500">
                      <div className={`p-1 px-2 rounded-lg w-max text-ubuntu-regular ${status === "Return" ? "bg-[#ffabab] text-[#ff3b3b]" : "bg-[#E0F0FF] text-[#0E57A2]"}`}>
                        {status}
                      </div>
                    </td>
