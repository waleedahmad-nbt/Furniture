...
const AccountSideBar = ({ profileImage, username }: any) => {
            ...
            <div className="bg-white w-full max-w-[839px] flex items-center justify-center pt-20 pb-14 relative">
              ...
              <div className="text-center">
                ...
                <div className="flex items-center mt-5 justify-between">
                  <button
                    onClick={() => setLogout(false)}
                    className="border border-gray-900 px-10 py-2 font-medium"
                  >
                    No
                  </button>
                  <button className="border border-transparent text-white bg-primary px-10 py-2 font-medium">
                    Yes
                  </button>
                </div>
              </div>
