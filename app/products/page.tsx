...
const Products = () => {
  ...
  const products = [
    { _id: "1", name: "Rocket stool", images: [Pro2, kitchen, bed], priceWas: "27.90", priceNow: "18.80", quantity: 2, status: "new" },
    { _id: "2", name: "Rocket stool", images: [Pro2, Pro1], priceWas: "27.90", priceNow: "18.80", quantity: 0, status: "sale" },
    { _id: "3", name: "Rocket stool", images: [Pro2], priceWas: "27.90", priceNow: "18.80", quantity: 5, status: "new" },
    { _id: "4", name: "Rocket stool", images: [Pro1], priceWas: "27.90", priceNow: "18.80", quantity: 2, status: "new" },
    { _id: "5", name: "Rocket stool", images: [Pro1], priceWas: "27.90", priceNow: "18.80", quantity: 2, status: "new" },
    { _id: "6", name: "Rocket stool", images: [Pro1], priceWas: "27.90", priceNow: "18.80", quantity: 2, status: "new" },
  ]
