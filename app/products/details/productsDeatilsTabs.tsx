...
import { ProductComment } from "@/app/components";
...
const ProductsDeatilsTabs = ({ product }: any) => {
  ...
  const imagesSlice = tab === Tabs[0] ? product?.images?.slice(0, 3) : tab === Tabs[2] ? product?.images?.slice(0, 2) : product?.images.slice(0, 1);
      ...
      <div>
        <div className="flex">
          {Tabs?.map((item: string, index: number) => (
            <button
              onClick={() => setTab(item)}
              className={`font-medium px-5 py-2 border-b-[3px] border-transparent ${tab === item ? "bg-white border-b-primary text-primary" : "text-[#858585]"}`}
              key={index}
            >{item}</button>
          ))}
        </div>
          ...
          {tab === Tabs[0] ? (
            ...
            <div>
              ...
              <div className="flex border-b py-5">
                ...
                <div className="w-1/2 flex justify-end text-gray-100">Kettal</div>
              </div>
              <div className="flex border-b py-5">
                <div className="w-1/2">Collection</div>
                <div className="w-1/2 flex justify-end text-gray-100">Jean-Marie Massaud</div>
              </div>
              <div className="flex border-b py-5">
                <div className="w-1/2">Color</div>
                <div className="w-1/2 flex justify-end text-gray-100">Brown Sugar</div>
              </div>
              <div className="flex border-b py-5">
              ...
              <div className="flex border-b py-5">
                ...
                <div className="w-1/2 flex justify-end text-gray-100">32″ H 21″ W 19″ D</div>
              </div>
              <div className="flex border-b py-5">
                <div className="w-1/2">Product weight</div>
                <div className="w-1/2 flex justify-end text-gray-100">20.72 lbs</div>
              </div>
              <div className="flex border-b py-5">
                <div className="w-1/2">Box dimensions</div>
                <div className="w-1/2 flex justify-end text-gray-100">37" H 21" W 24" D</div>
              </div>
              <div className="flex border-b py-5">
            ...
            <div>
                ...
                <div className="grow">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="relative grow">
                      ...
                      <span className={`block absolute inset-0 w-[50%] bg-[#3CB242] rounded-md`}></span>
                    </div>
                  ...
                  <div className="flex items-center gap-3 my-3">
                    <div className="flex items-center">
                      ...
                      {Array.from({ length: 3 })?.map((_, index) => (
                        <Image src={star} alt="product" width={18} height={18} key={index}/>
                      ))}
                    </div>
                    <div className="relative grow">
                      <span className="block h-[8px] w-full bg-[#E3E4E4] rounded-md"></span>
              ...
              <h2 className="font-medium text-gray-900 my-4 mr-10">Comment</h2>
